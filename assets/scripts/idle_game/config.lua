...
-- Sprite filenames (from dungeon_437 tileset)
-- These must match the "filename" field in sprites-0.json (not UUIDs)
config.SPRITE_GRASS = "d437_044_symbol_44.png"
config.SPRITE_TREE = "d437_005_club.png"
config.SPRITE_ROCK = "d437_033_symbol_33.png"
